...
class GalleryViewModel(application: Application) : AndroidViewModel(application) {
    ...
    // El escaneo inicial del MediaStore lo dispara MainActivity una sola vez,
    // justo cuando el permiso de fotos ya está concedido (ver LaunchedEffect
    // en MainActivity). Si se lanzara también aquí, se duplicaba el escaneo
    // completo de la galería y era la causa del "no responde" al abrir la app.
